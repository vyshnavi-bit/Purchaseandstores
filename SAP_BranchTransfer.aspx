<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="SAP_BranchTransfer.aspx.cs" Inherits="SAP_BranchTransfer" %>
                            ...
                            <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            <span align="center" style="font-size: 18px; font-weight: bold; color: #0252aa;"> SAP Branch Transfer Report</span><br />
                                        </div>
                                        <br />
                                ...
                                <asp:Button ID="btnPrint" runat="Server" CssClass="btn btn-primary" OnClientClick="javascript:CallPrint('divPrint');"
                                    Text="Print" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<asp:Button ID="btn_save" runat="server" Text="Save" CssClass="btn btn-primary" OnClick="btn_save_click" />&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<asp:Button ID="btnexport" runat="server" Text="Export to Excel" OnClick="btnexport_click" />
                            </asp:Panel>
