<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="StockRepairReport.aspx.cs" Inherits="StockRepairReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function get_stockrepair_details() {
            ...
            var data = { 'op': 'get_stockrepairReoprt_details', 'fromdate': fromdate, 'todate': todate };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
                        filldetails(msg);
        ...
        function filldetails(msg) {
            ...
            results += '<thead><tr><th scope="col"></th><th scope="col">sno</th><th scope="col">Name</th><th scope="col">Exp date</th><th scope="col">Remarks</th></tr></thead></tbody>';
            for (var i = 0; i < msg.length; i++) {
                ...
                results += '<td data-title="brandstatus" style="text-align:center;" class="2">' + msg[i].expdate + '</td>';
                results += '<td data-title="brandstatus" style="text-align:center;" class="2">' + msg[i].remarks + '</td>';
                //                }
                //                else {
                //                    results += '<tr><th><input id="btn_Print" type="button"   onclick="printclick(this);"  name="Edit" class="btn btn-primary" value="Print" /></th>'
                //                    results += '<td scope="row" class="1"  style="text-align:center;">' + msg[i].name + '</td>';
                //                    results += '<td data-title="brandstatus" style="text-align:center;" class="2">' + msg[i].expdate + '</td>';
                //                    results += '<td data-title="brandstatus" style="text-align:center;" class="2">' + msg[i].remarks + '</td>';
                //                    results += '<td data-title="brandstatus" style="text-align:center;display:none" class="2">' + msg[i].sno + '</td>';
        ...
        function printclick(thisid) {
            ...
            var data = { 'op': 'get_Sub_Stock_Repair_Report', 'refno': refno };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
                        var stockrepair = msg[0].stockrepairdetails;
                        var substockrepair = msg[0].stockrepairsubdetails;
                        $('#divPrint').css('display', 'block');
                        $('#Button2').css('display', 'block');
                        document.getElementById('srepair_name').innerHTML = stockrepair[0].name;
                        document.getElementById('repairvnumber').innerHTML = stockrepair[0].sno;
                        document.getElementById('expdate').innerHTML = stockrepair[0].expdate;
                        document.getElementById('outdate').innerHTML = stockrepair[0].doe;
                        document.getElementById('remarks').innerHTML = stockrepair[0].remarks;
                        fill_sub_stockrepair_details(substockrepair);
                    }
                }
                else {
        ...
        function fill_sub_stockrepair_details(msg) {
            ...
            results += '<thead><tr><th scope="col">Sno</th><th scope="col">Item Name</th><th scope="col">Item Code</th><th scope="col">UOM</th><th scope="col">Qty</th></tr></thead></tbody>';
            var j = 1;
            for (var i = 0; i < msg.length; i++) {
                ...
                results += '<td data-title="brandstatus" class="8">' + msg[i].sku + '</td>';
                results += '<td data-title="brandstatus" class="4">' + msg[i].uim + '</td>';
                results += '<td data-title="brandstatus" class="tammountcls">' + msg[i].quantity + '</td></tr>'
                j++;
            }
            var t2 = "Total";
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="content-header">
        <h1>
             Issue Come GetPass For Repair<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#">Issue Come GetPass For Repair</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Issue Come GetPass For Repair
                </h3>
            </div>
            <div class="box-body">
                <div runat="server" id="d">
                    ...
                    <div id="divstockdata" style="height: 300px; overflow-y: scroll;">
                    </div>
                </div>
                <div>
                </div>
                <div id="divPrint" style="display:none;">
                    ...
                    <div>
                     ...
                     <div align="center">
                        <span id="spnheading" style="font-size: 24px; font-weight: bold;">Issue Come GetPass For Repair</span>
                    </div>
                    <%--<div align="center">
                            ...
                            <tr>
                                <td style="width: 49%;"><%-- float: left;--%>
                                 <label style="font-size: 16px; font-weight: bold;">
                                          Name:</label>
                                    <span id="srepair_name"></span>
                                    <br />
                                    <label style="font-size: 16px; font-weight: bold;">
                                         Repair Voucher Number :</label>
