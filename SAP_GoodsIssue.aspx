<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="SAP_GoodsIssue.aspx.cs" Inherits="SAP_GoodsIssue" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section class="content-header">
        <h1>
            SAP Goods Issue<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#">SAP Reports</a></li>
            <li><a href="#">SAP Goods Issue</a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>SAP Goods Issue Details
                </h3>
            </div>
            <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td style="padding-top:20px">
                                    <asp:Button ID="btnGenerate" Text="Generate" runat="server" OnClientClick="OrderValidate();"
                                        CssClass="aspbutton" OnClick="btnGenerate_Click" />
                                </td>
                            </tr>
                        </table>
                            ...
                            <div id="divPrint">
                                <div style="width: 100%;">
                                    ...
                                    <div style="left: 0%; text-align: center;">
                                        ...
                                        <div align="center">
                                            <span style="font-size: 18px; text-decoration: underline; color: #0252aa;">SAP Goods Issue(Branch Consumption)</span>
                                        </div>
                                        <div align="center">
                                            <table style="width: 50%;">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:Label ID="lblbranchName" runat="server" Text="" ForeColor="Red"></asp:Label>
                                                    </td>
                                                    <td>
                                                        Date:
                                                    </td>
