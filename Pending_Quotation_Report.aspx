<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="Pending_Quotation_Report.aspx.cs" Inherits="Pending_Quotation_Report" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                     Pending Quotation Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Pending Quotation Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Pending Quotation Report
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblfrom_date" runat="server" Font-Bold="true" Text="Label">From Date</asp:Label>&nbsp;
                                    ...
                                    <td>
                                        <asp:Label ID="lblto_date" runat="server" Font-Bold="true" Text="Label">To Date</asp:Label>&nbsp;
                            ...
                            <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Pending Quotation Report</span><br />
                                        </div>
                                        </br>
                                ...
                                <br />
                                <br />
                                <asp:Button ID="btnPrint" runat="Server" CssClass="aspbutton" OnClientClick="javascript:CallPrint('divPrint');"
                                    Text="Print" />
                            </asp:Panel>
