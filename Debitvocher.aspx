<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="Debitvocher.aspx.cs" Inherits="Debitvocher" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function save_stock_transfer_click() {
            ...
            var Data = { 'op': 'save_debitvocher_click', 'freight': freight, 'invoiceno': invoiceno, 'invoicedate': invoicedate, 'tobranch': tobranch, 'transportname': transportname, 'invoicetype': invoicetype, 'vehicleno': vehicleno, 'btnval': btnval, 'remarks': remarks, 'sno': sno, 'status': status, 'mrnno': mrnno, 'filldetails': filldetails };
            var s = function (msg) {
                if (msg) {
        ...
        function get_StockTransfer_details() {
            var data = { 'op': 'get_debitvocher_details' };
            var s = function (msg) {
                if (msg) {
                    if (msg.length > 0) {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="content-header">
        <h1>
            Debit Vocher Entry<small>Preview</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
            <li><a href="#"> Debit Vocher Entry </a></li>
        </ol>
    </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i> Debit Vocher Entry
                </h3>
            </div>
            <div class="box-body">
                <div id="showlogs" align="center">
                    <div class="input-group" style="padding-left:88%">
                        <div class="input-group-addon">
                            <span class="glyphicon glyphicon-plus-sign"></span> <span id="add_Stock">Add Debit Vocher</span>
                        </div>
                    </div>
                </div>
                ...
                <div id='fillform' style="display: none;">
                    ...
                    <table align="center">
                        ...
                        <tr>
                            ...
                            <td style="width:5px"></td>
                             <td style="height: 40px;">
                                <label id="Label1">MRN Number</label><span style="color: red;"></span>
                                <input id="txtmrnno" type="text" class="form-control" name="invoiceno" placeholder="Enter MRN Number" />
                            </td>
                        </tr>
                        <tr>
