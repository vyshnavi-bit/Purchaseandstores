<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="SubCategoryWiseReport.aspx.cs" Inherits="SubCategoryWiseReport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                     Sub Category Wise  Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#"> Sub Category Wise  Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Sub Category Wise  Report
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;"> SubCategory Wise  Report</span><br />
                                        </div>
                                        <br />
                                           <asp:GridView ID="grdReports" runat="server" Style="width: 100%;" Font-Bold="true"  OnRowCommand="grdReports_RowCommand">
                                            <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                            ...
                            <div id="divMainAddNewRow" class="pickupclass" style="text-align: center; height: 100%;
                                ...
                                <div id="divAddNewRow" style="border: 5px solid #A0A0A0; position: absolute; top: 0%;
                                 ...
                                 <div id="divclose" style="width: 35px; top: 0%; right: 0%;left:97.5%; position: absolute;
                                    z-index: 99999; cursor: pointer;">
                                    <img src="Images/PopClose.png" style="padding-right:172px" alt="close" onclick="popupCloseClick();" />
                                </div>
                            </div>
