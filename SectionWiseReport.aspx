    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Section Wise Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Section Wise Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Section Wise Report
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Section Wise Report</span><br />
                                        </div>
                                        <br />
                            ...
                            <div id="divMainAddNewRow" class="pickupclass" style="text-align: center; height: 100%;
                                ...
                                <div id="divAddNewRow" style="border: 5px solid #A0A0A0; position: absolute; top: %;
                                    background-color: White; width: 100%; height: 0%; -webkit-box-shadow: 1px 1px 10px rgba(50, 50, 50, 0.65);
                                ...
                                <div id="divclose" style="width: 35px; top: 0%; right: .5%; position: absolute;
                                    z-index: 99999; cursor: pointer;">
                                    <img src="Images/PopClose.png" alt="close" style="padding-top:0px;padding-left:20px" onclick="popupCloseClick();" />
