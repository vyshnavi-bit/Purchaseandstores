<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="VerifyreturnableMaterial.aspx.cs" Inherits="VerifyreturnableMaterial" %>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#txtRecievedDate').val(yyyy + '-' + mm + '-' + dd);
        scrollTo(0, 0);
    });
    ...
    function GetFixedrows() {
        ...
        results += '</table></div>';
        $("#div_returnmaterial").html(results);
    }
    
    function saveInternalDetails() {
        var name = document.getElementById('txtName').value;
        var issudate = document.getElementById('txtDate').value;
        var Recieveremarks = document.getElementById('txtRecieveremarks').value;
        ...
        var Data = { 'op': 'save_Verify_Returnble_Material_click', 'others': others, 'name': name, 'type': ddltype, 'dname': ddlname, 'issudate': issudate, 'btnVal': btnval, 'status': status, 'sno': sno, 'issueremarks': issueremarks, 'fillreturn': fillreturn, 'Recieveremarks': Recieveremarks, 'receiveddate': RecievedDate };
        var s = function (msg) {
            if (msg) {
                if (msg.length > 0) {
                    alert(msg);
    ...
    function get_Returnble_Material_details() {
        var data = { 'op': 'get_Returnble_Material_details' };
        var s = function (msg) {
            if (msg) {
                if (msg.length > 0) {
                    filldetails(msg);
    ...
    function filldetails(msg) {
        ...
        for (var i = 0; i < retundetails.length; i++) {
            results += '<tr style="background-color:' + COLOR[l] + '">';//<td><input id="btn_poplate" type="button"  onclick="getme(this)" name="submit" class="btn btn-primary" value="Verify" /></td>
    ...
    function getme(thisid) {
        ...
        document.getElementById('btn_save').innerHTML = "Verify";
        $("#div_SectionData").hide();
        $("#fillform").show();
        $('#showlogs').hide();
...
<section class="content-header">
        <h1>
            Verify Returnable Material
        </h1>
   <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>Operation</a></li>
            <li><a href="#">Verify Returnable Material</a></li>
        </ol> 
  </section>
    <section class="content">
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <i style="padding-right: 5px;" class="fa fa-cog"></i>Verify Returnable Material Details
                </h3>
            </div>
            <div class="box-body">
                <div id="showlogs" align="center">
                    <%--<input id="btn_addNewSection" type="button" name="submit" value='Returnable Material' class="btn btn-primary" onclick="showdesign()" />--%>
                    <div class="input-group" style="padding-left:85%">
                        <div class="input-group-addon">
                            <span class="glyphicon glyphicon-plus-sign" onclick="showdesign()"></span> <span id="btn_addNewSection" onclick="showdesign()" >Returnable Material</span>
                        </div>
                    </div>
                </div>
                ...
                <div id='fillform' style="display: none;">
                   <table align="center">
                       ...
                       <tr>
                            <td style="height:40px;">
                                <label>Recieved Date</label><span style="color: red;">*</span>   
                                <div class="input-group date" style="width:100%;">
                                  <div class="input-group-addon cal">
                                    <i class="fa fa-calendar"></i>
                                  </div>
                                  <input id="txtRecievedDate" type="date"  name="Date" class="form-control"/>
                                </div>  
                            </td>
                      </tr>
                       <tr>
                      ...
                      <tr>
                           <td colspan="4" style="height:40px;">
                             <label>Issue Remarks</label><span style="color: red;"></span>
                             <textarea id="txtremarks" class="form-control" type="text" rows="4" cols="45" placeholder="Enter Remarks Specification"></textarea>
                            </td>  
                      </tr>
                       <tr>
                           <td colspan="4" style="height:40px;padding-top:5px">
                             <label>Received Remarks</label><span style="color: red;"></span>
                                <textarea id="txtRecieveremarks" class="form-control" type="text" rows="4" cols="45" placeholder="Enter Remarks Specification"></textarea>
                            </td>  
                      </tr>
                               ...
                               <table>
                                   <tr>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                        <span class="glyphicon glyphicon-ok" id="btn_save1" onclick="saveInternalDetails()"></span> <span id="btn_save" onclick="saveInternalDetails()">Save</span>
                                  </div>
                                  </div>
                                    </td>
