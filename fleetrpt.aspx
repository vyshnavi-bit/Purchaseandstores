<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="fleetrpt.aspx.cs" Inherits="fleetrpt" %>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                            ...
                            <tr>
                                ...
                                <td style="width:6px;"></td>
                                    <td style="padding-top:20px">
                                        <asp:Button ID="Button1" runat="server" Text="GENERATE" CssClass="btn btn-primary"
                            ...
                            <asp:Panel ID="hidepanel" runat="server">
                                ...
                                <asp:Button ID="Button2" runat="Server" CssClass="btn btn-primary" OnClick="btnUpdate_Click" Text="save" />
                            </asp:Panel>
