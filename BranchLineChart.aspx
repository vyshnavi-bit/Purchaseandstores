<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true"
    CodeFile="BranchLineChart.aspx.cs" Inherits="BranchLineChart" %>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div style="width: 100%;" align="center">
                    ...
                    <td id="branch_selection" style="width: 200px; height: 50px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="button" id="submit" value="Submit" class="btn btn-success" onclick="Get_Branch_Wise_LineChart()" />
                            </td>
                        </tr>
              ...
              <div id="example" class="k-content">
                ...
                <script type="text/javascript">
                    ...
                    function selectedchange() {
                        ...
                        if (type == "All") {
                            $("#branch_selection").css("display", "none");
                        }
                        else {
                            $("#branch_selection").css("display", "block");
                        }
                    ...
                    function Get_Branch_Wise_LineChart() {
                        ...
                        var type = document.getElementById('ddltype').value;
                        var data = { 'op': 'Get__LineChart', 'toyear': toyear, 'fromyear': fromyear, 'mymonth': mymonth, 'tomonth': tomonth, 'id': branchid, 'type': type };
                        var s = function (msg) {
                            if (msg) {
                    ...
                    function lineChart(databind) {
                        ...
                        for (var k = 0; k < databind.length; k++) {
                            ...
                            var type1 = document.getElementById('ddltype').value;
                            for (var i = 0; i < databind.length; i++) {
                                if (type1 == "All") {
                                    newYarray.push({ 'data': databind[i].StoresValue.split(','), 'name': databind[i].branchname });
                                }
                                else {
