<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="SAP_PO_REPORT.aspx.cs" Inherits="SAP_PO_REPORT" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                     SAP PO Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">  SAP PO Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i> SAP PO Report
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                            <table>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblfrom_date" Font-Bold="true" runat="server" Text="Label">PO Date</asp:Label>&nbsp;
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">SAP PO Report</span><br />
                                        </div>
                                        ...
                                        <div>
                                            <asp:GridView ID="grdReports" runat="server" CssClass="gridcls" Font-Bold="true" Font-Size="Smaller" ForeColor="White" GridLines="Both" OnRowDataBound="grdReports_RowDataBound" Width="100%">
