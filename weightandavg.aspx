<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="weightandavg.aspx.cs" Inherits="weightandavg" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                    Item Wise Ledger Report <small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">Item Wise Ledger Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i>Item Wise Ledger Details
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                            <table>
                                <tr>
                                    <td style="width: 350PX;padding-top: 17px;">
                                        <asp:Label ID="Label1" Font-Bold="true" runat="server" Text="Label">Product Name</asp:Label>&nbsp;
                                        <asp:TextBox ID="TextBox1" runat="server" placeholder="Enter Product Name" CssClass="form-control"></asp:TextBox>
                                    </td>
                                    <td style="width: 6px;">
                                    </td>
                                    <td style="padding-top: 16PX;">
                                        <asp:Label ID="Label4" Font-Bold="true" runat="server" Text="Label">From Date</asp:Label>&nbsp;
                                    ...
                                    <td style="padding-top: 16PX;">
                                        <asp:Label ID="Label5" Font-Bold="true" runat="server" Text="Label">To Date</asp:Label>&nbsp;
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span style="font-size: 18px; font-weight: bold; color: #0252aa;">Ledger Wise Report</span><br />
                                        </div>
