<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="TotStockTransferReport.aspx.cs" Inherits="StockTransferReport" %>
    ...
    <asp:UpdatePanel ID="updPanel" runat="server">
        <ContentTemplate>
            <section class="content-header">
                <h1>
                        Total Outward Entry Report<small>Preview</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i>Reports</a></li>
                    <li><a href="#">  Total Outward Entry Report</a></li>
                </ol>
            </section>
            <section class="content">
                <div class="box box-info">
                    <div class="box-header with-border">
                        <h3 class="box-title">
                            <i style="padding-right: 5px;" class="fa fa-cog"></i> Total Outward Entry Report
                        </h3>
                    </div>
                    <div class="box-body">
                        <div align="center">
                            <table>
                                ...
                                <td style="width:6px;"></td>
                                 ...
                                 <td style="width:6px;"></td>
                                    <td>
                                        <asp:Label ID="Label1" Font-Bold="true" runat="server" Text="Label">Tax Type</asp:Label>&nbsp;
                                        <asp:DropDownList ID="ddltype" runat="server" CssClass="form-control">
                                            <asp:ListItem>WithTax</asp:ListItem>
                                            <asp:ListItem>WithOutTax</asp:ListItem>
                                    ...
                                    <div style="width: 100%;">
                                        ...
                                        <div align="center">
                                            ...
                                            <asp:Label ID="lblAddress" runat="server" Font-Bold="true" Font-Size="12px" ForeColor="#0252aa"
                                                Text=""></asp:Label>
                                            <br />
                                            <span align="center" style="font-size: 18px; font-weight: bold; color: #0252aa;"> Total Outward Entry Report</span><br />
                                        </div>
                                        <br />
