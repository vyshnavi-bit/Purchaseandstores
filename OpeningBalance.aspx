<%@ Page Title="" Language="C#" MasterPageFile="~/Operations.master" AutoEventWireup="true" CodeFile="OpeningBalance.aspx.cs" Inherits="OpeningBalance" %>
                            ...
                            <asp:Panel ID="hidepanel" runat="server" Visible='false'>
                                <div id="divPrint">
                                    <div style="width: 100%;">
                                        ...
                                        <asp:GridView ID="grdReports" runat="server"  Style="width: 100%;text-align:right;" Font-Bold="true"
                                          OnRowCreated="grdReports_RowCreated" OnRowCommand="grdReports_RowCommand"   OnRowDataBound="grdReports_RowDataBound">
                                        </asp:GridView>
                                        </div>
                                        <br />
                                ...
                                <asp:Button ID="btnPrint" runat="Server" CssClass="btn btn-primary" OnClientClick="javascript:CallPrint('divPrint');"
                                    Text="Print" /> &nbsp
                                <asp:Button ID="btn_finalize" runat="server" CssClass="btn-primary" OnClick="finalize_stockclosing" Text="FINALIZE" />
                            </asp:Panel>
